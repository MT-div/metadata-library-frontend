// src/features/admin/ManageItemSetsPage.tsx
import { useManageItemSets } from "../../hooks/adminHooks/useManageItemSets";
...
export const ManageItemSetsPage = () => {
  ...
  const {
    ...
    filteredSets,
    allItems,
    getItemTitle, // تستخدم في استعراض خيارات الفلترة
  } = useManageItemSets();
                ...
                <div>
                  <h2
                    style={{
                      ...
                      margin: "0 0 4px",
                      textDecoration: isSelectedSetDeleted
                        ? "line-through"
                        : "none",
                    }}
                  >
                      ...
                      >
                        ...
                        <button
                          ...
                          style={{
                            ...
                            fontWeight: 600,
                            cursor:
                              isProcessing || isSelectedSetDeleted
                                ? "not-allowed"
                                : "pointer",
                            opacity:
                              isProcessing || isSelectedSetDeleted ? 0.4 : 1,
                            transition: "all 0.15s",
                            whiteSpace: "nowrap",
                          }}
                          onMouseEnter={(e) => {
                            if (!isProcessing && !isSelectedSetDeleted)
